// Koka generated module: "concur/dom", koka version: 0.9.0-dev
if (typeof define !== 'function') { var define = require('amdefine')(module) }
define(['./std_core', './sys_dom_types', './std_data_dict', './sys_dom_html_htmlElement', './concur_props'], function($std_core, $sys_dom_types, $std_data_dict, $sys_dom_html_htmlElement, $concur_props) {
"use strict";
var $concur_dom  = {};
 
// externals
var superfine = function() {
  var DEFAULT = 0
  var RECYCLED_NODE = 1
  var TEXT_NODE = 2
  ...
  return {
    ...
    patch: function(lastNode, nextNode, container) {
      var lifecycle = []
...
/* superfine.h */
function h(name, props, children) /* (name : string, props : concur/props/props<concur/props/prop>, children : vector<vnode>) -> vnode */  {
  return superfine.h(name, props, children);
}
 
/* Strings can be passed as is to `h` */
function t(str) /* (str : string) -> vnode */  {
  return str;
}
 
/* superfine.patch */
function patch(lastNode, nextNode, container) /* (lastNode : null<vnode>, nextNode : vnode, container : sys/dom/types/htmlElement) -> <st<sys/dom/types/hdom>,ui,exn,net,console,ndet> vnode */  {
  return superfine.patch(lastNode, nextNode, container);
}
 
// exports
$concur_dom = $std_core._export($concur_dom, {
  h           : h,
  t           : t,
  patch       : patch
});
